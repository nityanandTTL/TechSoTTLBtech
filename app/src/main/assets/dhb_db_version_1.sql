...
CREATE TABLE order_details (VisitId character varying(100),Slot character varying(20),Response character varying (200),SlotId integer,BrandId integer,OrderNo character varying(50),Address character varying(500),Pincode character varying(10),Mobile character varying(20),Email character varying(50),PayType character varying(50),AmountDue integer,Margin integer,Discount integer,Refcode character varying(50),ProjId character varying(50),ReportHC integer,isTestEdit character varying(20),isAddBen character varying(20),kits character varying(500),Distance integer,createdAt bigint,createdBy character varying(100),updatedAt bigint,updatedBy character varying(100),recordStatus character varying(10),syncAction character varying(10),syncStatus character varying(10));

DROP TABLE IF EXISTS beneficiary_details;
CREATE TABLE beneficiary_details (benId integer,OrderNo character varying(50),Name character varying(100),Age integer,Gender character varying(20),tests character varying(200),Fasting character varying(50),Venepuncture BLOB,barcodedtl json,sampleType json,createdAt bigint,createdBy character varying(100),updatedAt bigint,updatedBy character varying(100),recordStatus character varying(10),syncAction character varying(10),syncStatus character varying(10));
