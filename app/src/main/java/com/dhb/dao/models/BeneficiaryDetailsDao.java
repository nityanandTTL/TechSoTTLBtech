...
public class BeneficiaryDetailsDao {
	...
	public ArrayList<BeneficiaryDetailsModel> getModelsFromOrderNo(String orderNo) {
		...
		ArrayList<BeneficiaryDetailsModel> orderDetailsModelArr = new ArrayList<>();
		...
		if (cursor != null && (cursor.moveToFirst())){
			do {
				BeneficiaryDetailsModel orderDetailsModel = getModelFromCursor(cursor);
	...
	public ArrayList<BeneficiaryDetailsModel> getModelsFromBenId(String benId) {
		...
		ArrayList<BeneficiaryDetailsModel> orderDetailsModelsArr = new ArrayList<>();
	...
	public BeneficiaryDetailsModel getModelFromId(int benId){
		BeneficiaryDetailsModel orderDetailsModel = null;
		if(benId!=0) {
