...
import com.dhb.models.data.BrandCurrencyModel;
...
public class BrandMasterDao {
	...
	private BrandMasterModel getModelFromCursor(Cursor cursor) {
		...
		testRateMasterModel.setAuthentication(Boolean.parseBoolean(cursor.getString(cursor.getColumnIndex(IS_AUTHENTICATION))));
		...
		testRateMasterModel.setWallet(Boolean.parseBoolean(cursor.getString(cursor.getColumnIndex(WALLET))));
		testRateMasterModel.setMultiplePayments(Boolean.parseBoolean(cursor.getString(cursor.getColumnIndex(MULTIPLE_PAYMENTS))));
	...
	public ContentValues getContentValuesFromModel(BrandMasterModel brandMasterModel) {
		...
		values.put(IS_AUTHENTICATION, brandMasterModel.isAuthentication());
		...
		values.put(WALLET, brandMasterModel.isWallet());
		values.put(MULTIPLE_PAYMENTS, brandMasterModel.isMultiplePayments());
