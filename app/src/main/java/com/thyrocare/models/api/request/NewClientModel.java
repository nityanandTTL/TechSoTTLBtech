...
public class NewClientModel {
    private String Address,Brand,Channel,Country,Email,InchargeName,Name,TspOLc,VerificationSource,apikey,
            mobile,phone_no,EntryType,pincode,website,APP,File,opType,Latitute,Longitude,Visiting_Card;
    ...
    public String getTspOLc() {
        return TspOLc;
    }

    public void setTspOLc(String tspOLc) {
        TspOLc = tspOLc;
    }
