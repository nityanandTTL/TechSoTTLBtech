...
/**
 * The type Visit order display adapter.
 */
public class VisitOrderDisplayAdapter extends BaseAdapter {
    ...
    /**
     * The New time after minus sixty 1.
     */
    ...
    Date strDate;
    /**
     * The Fasting flag int.
     */
    int fastingFlagInt = 0;
    /**
     * The Apitimein hhmm format.
     */
    Date apitimeinHHMMFormat;

    /**
     * The Is auto time selected.
     */
...
//neha g------------
    ...
    /**
     * Instantiates a new Visit order display adapter.
     *
     * @param activity                                      the activity
     * @param orderDetailsResponseModels                    the order details response models
     * @param visitOrderDisplayRecyclerViewAdapterDelegate  the visit order display recycler view adapter delegate
     * @param refreshDelegate                               the refresh delegate
     * @param visitOrderDisplayyRecyclerViewAdapterDelegate the visit order displayy recycler view adapter delegate
     * @param orderPassRecyclerViewAdapterDelegate          the order pass recycler view adapter delegate
     * @param callbackforShowCaseDelegate                   the callbackfor show case delegate
     */
//private refreshDelegate refreshDelegate;
    ...
    private void initData(final FoldingCellViewHolder holder, final int pos) {
        ...
        if (orderVisitDetailsModelsArr.size() > pos
            ...
            Log.e("Direct visit", "initData: "+orderVisitDetailsModelsArr.get(pos).getAllOrderdetails().get(0).isDirectVisit() );
            if (orderVisitDetailsModelsArr.get(pos).getAllOrderdetails().get(0).isDirectVisit()) {
                holder.mainright.setBackgroundColor(activity.getResources().getColor(R.color.directVisit));
...
//TODO NEHA
    ...
    /**
     * The type Call patch request async task delegate result.
     */
    ...
    private class OrderStatusChangeApiAsyncTaskDelegateResult implements ApiCallAsyncTaskDelegate {
        /**
         * The Order details model.
         */
        OrderDetailsModel orderDetailsModel;

        /**
         * Instantiates a new Order status change api async task delegate result.
         *
         * @param orderDetailsModel the order details model
         */
    ...
    private class FoldingCellViewHolder {
        ...
        /**
         * Instantiates a new Folding cell view holder.
         *
        ...
        private void initUI(View itemView) {
            ...
            direct_visit = (TextView) itemView.findViewById(R.id.direct_visit);
            locationdata = (TextView) itemView.findViewById(R.id.location_datas);
            pindata = (TextView) itemView.findViewById(R.id.pincode_data);
