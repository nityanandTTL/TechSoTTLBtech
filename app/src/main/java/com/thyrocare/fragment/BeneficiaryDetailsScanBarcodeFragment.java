...
public class BeneficiaryDetailsScanBarcodeFragment extends AbstractFragment {
    ...
    public static boolean IS_RBS_PPBS = false;
    ...
    public static String rbsbarcode = "";
    ...
    private boolean isRBSScan = false;
    public static BeneficiaryBarcodeDetailsModel beneficiaryBarcodeDetailsModelRBS;
...
//                lin_TRFUpload.setVisibility(View.VISIBLE);
            ...
            if (!isBarcodeAndSampleListSame) {
                ...
                if (beneficiaryDetailsModel.getTestsCode().equalsIgnoreCase("RBS,PPBS") || beneficiaryDetailsModel.getTestsCode().equalsIgnoreCase("PPBS,RBS")) {
                    ...
                    beneficiaryBarcodeDetailsModelRBS.setBenId(beneficiaryDetailsModel.getBenId());
                    ...
                    beneficiaryBarcodeDetailsModelRBS.setOrderNo(beneficiaryDetailsModel.getOrderNo());
                    IS_RBS_PPBS = true;
                }
                ...
                /*if(beneficiaryDetailsModel.getTestsCode().equalsIgnoreCase("RBS,PPBS")||beneficiaryDetailsModel.getTestsCode().equalsIgnoreCase("PPBS,RBS")){
                    ...
                    beneficiaryBarcodeDetailsModel.setBenId(beneficiaryDetailsModel.getBenId());
                    beneficiaryBarcodeDetailsModel.setId(DeviceUtils.getRandomUUID());
                    beneficiaryBarcodeDetailsModel.setSamplType("FLUORIDE-PP");
                    beneficiaryBarcodeDetailsModel.setOrderNo(beneficiaryDetailsModel.getOrderNo());
                    beneficiaryDetailsModel.getBarcodedtl().add(beneficiaryBarcodeDetailsModel);
                }*/
        ...
        if (beneficiaryDetailsModel != null
           ...
           /* for (final BeneficiaryBarcodeDetailsModel beneficiaryBarcodeDetailsModel :
            ...
            for (int i = 0; i < beneficiaryDetailsModel.getBarcodedtl().size(); i++) {
                ...
                TextView edtBarcodeRBS = (TextView) tr.findViewById(R.id.edt_barcode_rb);

                ImageView imgScan = (ImageView) tr.findViewById(R.id.scan_barcode_button);

                ImageView imgScanRBS = (ImageView) tr.findViewById(R.id.scan_barcode_button_rb);

                LinearLayout ll_rbs = (LinearLayout) tr.findViewById(R.id.ll_rbs);

                if (beneficiaryDetailsModel.getTestsCode().equalsIgnoreCase("RBS,PPBS") || beneficiaryDetailsModel.getTestsCode().equalsIgnoreCase("PPBS,RBS")) {
                    ll_rbs.setVisibility(View.VISIBLE);
                    if (!IS_RBS_PPBS) {
                        IS_RBS_PPBS = true;
                    }

                } else {
                    ll_rbs.setVisibility(View.GONE);
                }
                ...
                if (beneficiaryDetailsModel.getTestsCode().equalsIgnoreCase("RBS,PPBS") || beneficiaryDetailsModel.getTestsCode().equalsIgnoreCase("PPBS,RBS")) {
                    beneficiaryBarcodeDetailsModelRBS.setBarcode("" + rbsbarcode);
                }

                Log.e(TAG_FRAGMENT, "rbsbarcode: " + rbsbarcode);
                ...
                imgScanRBS.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        isRBSScan = true;
    ...
    private class GetTestListApiAsyncTaskDelegateResult implements ApiCallAsyncTaskDelegate {
        ...
        public void apiCallResult(String json, int statusCode) throws JSONException {
            if (statusCode == 200) {
                ...
                BeneficiaryDetailsScanBarcodeFragment.CustomDialogClass cdd = new BeneficiaryDetailsScanBarcodeFragment.CustomDialogClass(activity);
                cdd.show();
