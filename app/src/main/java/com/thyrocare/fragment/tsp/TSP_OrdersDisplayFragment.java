package com.thyrocare.fragment.tsp;
...
import com.thyrocare.adapter.tsp.Tsp_OrderDisplayAdapter;
import com.thyrocare.adapter.tsp.Tsp_OrderDisplayAdapter_new;
 ...
 */
public class TSP_OrdersDisplayFragment extends AbstractFragment {

    public static final String TAG_FRAGMENT = "TSP_OrdersDisplayFragment";
    ...
    public static TSP_OrdersDisplayFragment newInstance() {
        TSP_OrdersDisplayFragment fragment = new TSP_OrdersDisplayFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_tsp_orders_display, container, false);
        initUI();
        fetchData();
        setListener();
        return rootView;
    ...
    private void prepareRecyclerView() {
        ...
        if (orderDetailsResponseModels.size() > 0) {
            Tsp_OrderDisplayAdapter_new visitOrderDisplayRecyclerViewAdapter = new Tsp_OrderDisplayAdapter_new(activity, orderDetailsResponseModels, new VisitOrderDisplayRecyclerViewAdapterDelegateResult(), new refreshDelegate() {
                @Override
            ...
            recy_Orderlist.setAdapter(visitOrderDisplayRecyclerViewAdapter);
