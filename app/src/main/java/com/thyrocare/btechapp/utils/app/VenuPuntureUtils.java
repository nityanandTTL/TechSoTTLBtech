...
public class VenuPuntureUtils {
    ...
    public static void DeleteBenFromVenupumtureTempGlobalArry(int BenID) {
        ...
        if (benremoved) {
            MessageLogger.PrintMsg("Ben details removed from Temporary Venupunture Arraylist");
        } else {
            MessageLogger.PrintMsg("Ben details not found in Temporary Venupunture Arraylist");
        }
    }
    ...
    public static void UpdateBenID_IN_VenupumtureTempGlobalArry(String OldBenID, String NewBenID) {
        ...
        if (benIDUpdated) {
            MessageLogger.PrintMsg("Ben ID Updated Successfully in Temporary Venupunture Arraylist");
        } else {
            MessageLogger.PrintMsg("Ben details not found in Temporary Venupunture Arraylist");
        }
    }
